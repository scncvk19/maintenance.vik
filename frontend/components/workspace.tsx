...
import { api, billingCycles, categories, conditions, Dashboard, day, json, kinds, money, Row, statuses, today, transactionCategories, workKinds } from '../lib/data';
  ...
  return <div className="app-shell">
    ...
    <div className="main-shell">
      ...
      <main>
        ...
        {section === 'finance' && <FinanceOverview assets={assets} components={rows.components || []} transactions={rows.transactions || []} contracts={rows.contracts || []} onCreateIncome={assetId => setEditor({resource:'transactions', defaultDirection:'income', defaultAssetId:assetId})} onCreateExpense={assetId => setEditor({resource:'transactions', defaultDirection:'expense', defaultAssetId:assetId})} onCreateContract={assetId => setEditor({resource:'contracts', defaultAssetId:assetId})} onEditTransaction={row => setEditor({resource:'transactions', row})} onEditContract={row => setEditor({resource:'contracts', row})}/>} 
