  ...
  return <div className="app-shell">
    ...
    <div className="main-shell">
      ...
      <main>
        ...
        {section === 'finance' && <FinanceOverview assets={assets} transactions={rows.transactions || []} contracts={rows.contracts || []} onCreateIncome={() => setEditor({resource:'transactions', defaultDirection:'income'})} onCreateExpense={() => setEditor({resource:'transactions', defaultDirection:'expense'})} onCreateContract={() => setEditor({resource:'contracts'})} onEditTransaction={row => setEditor({resource:'transactions', row})} onEditContract={row => setEditor({resource:'contracts', row})}/>} 
