...
export default function Workspace() {
  ...
  const [editor, setEditor] = useState<{resource: string; row?: Row; defaultKind?: string; defaultAssetId?: string; defaultDueDate?: string; defaultDirection?: 'income' | 'expense'} | null>(null);
  ...
  return <div className="app-shell">
    ...
    <div className="main-shell">
      ...
      <main>
        ...
        {section === 'finance' && <FinanceOverview assets={assets} transactions={rows.transactions || []} contracts={rows.contracts || []} onCreateIncome={assetId => setEditor({resource:'transactions', defaultDirection:'income', defaultAssetId:assetId})} onCreateExpense={assetId => setEditor({resource:'transactions', defaultDirection:'expense', defaultAssetId:assetId})} onCreateContract={assetId => setEditor({resource:'contracts', defaultAssetId:assetId})} onEditTransaction={row => setEditor({resource:'transactions', row})} onEditContract={row => setEditor({resource:'contracts', row})}/>} 
